        ...
        <nav className="navbar navbar-expand-lg navbar-dark bg-light py-3 sticky-top">
            <div className="container">
                <NavLink className="navbar-brand fw-bold fs-4 px-2" to="/">
                    <img src="./assets/Logo.png" alt="The Sark" style={{ width: '100px', height: 'auto' }} />
                </NavLink>
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <div className="buttons text-center">
                        <NavLink to="/my-account" className="btn btn-outline-dark m-2"><i className="fa fa-user-plus mr-1"></i> My Account</NavLink>
